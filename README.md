...
```javascript
import isPRNGLike from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-prng-like@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-prng-like/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/assert-is-prng-like/actions/workflows/test.yml?query=branch:v0.2.2
